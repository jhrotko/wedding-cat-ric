...
const formatTime = (time) => {
  ...
  return `${days} DIAS ${hours < 10 ? "0" : ""}${hours} HORAS ${
    minutes < 10 ? "0" : ""
  }${minutes} MINUTOS ${seconds < 10 ? "0" : ""}${seconds} SEGUNDOS`;
};

const CountDownTimer = () => {
  const targetDate = new Date("2025-10-04T00:16:00"); // Set your target date here
